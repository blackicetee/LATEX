...
\title{How to get started with Artificial Neural Networks (ANN's) for Reinforcement Learning (RL) problems?}
...
\section{My short introduction of ANN's in RL problem}
...
\begin{itemize}
\item The agent only gets a numerical reward from the environment at the end of a decision-sequence.
\item How should the reward be assigned to the different steps of a decision-sequence?
\item How to handle vast action- and state-spaces?
\end{itemize}
...
\section{Conference "Rise of AI" May 2018, Berlin, Germany}
The conference is for decision-makers, game-changers, opinion-influencers and knowledge-seekers. The conference provides a wide area of Artificial Intelligence (AI) topics, for example (see the official Website “http://riseof.ai/”):  
\begin{enumerate}
\item Deep Learning: Future of AI ~ “ Inspired by the recend advances in Deep Learning, this talk will introduce deep learning, explain its impact, and provide an outlook about where the journey will go and how the area of deep learning will potentially evolve and therefore change the current AI landscape. ” [Dr. Damian Borth]
\item How will AI be, if it is smarter than humans? What problems can be solved better by AI than by humans? [Prof. Dr. Hans Uszkoreit]
\end{enumerate}

\section{Reasoning, conference topics mentioned above associated with my research topic:}
