...
\title{(Deep) Reinforcement Learning\\ understanding Policy Gradient}
...
Ein MDP ist ein sequentielles Entscheidungsproblem. Eine Sequenz $S_0, A_0, S_1, A_1 ... S_t, A_t$ beschreibt die Interaktion des Agenten mit dem MDP.
...
\begin{equation}
\begin{aligned}
\rho(\pi) & = \lim\limits_{n \rightarrow \infty}{\frac{1}{n} E\{r_1 + r_2 + ... + r_n | \pi\}} \\
