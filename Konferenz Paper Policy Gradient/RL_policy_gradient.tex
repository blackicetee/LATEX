...
\section{Grundlagen}
Für ein besseres Verständnis des Policy Gradient Verfahrens wird nachfolgend ein Überblick der wichtigsten Grundlagen des Reinforcement Learnings (RL) gegeben. Das Problem des RL, das Agentenmodell, Maximierung der erwarteten Gewinne.

\subsection{Das Problem}
Agent in einer Unbekannten Umgebung (Versuch und Irrtum)

\subsection{Komponenten eines RL Agenten}

\subsubsection{Die Strategie (policy)}
...
\subsubsection{Die Bewertungsfunktion (value function)}
Bewertet wie gut jeder Zustand und/oder jede Aktion ist. 

\subsubsection{Das Modell}
Markov-Entscheidungsprozess
Die vom Agenten genutzte Repräsentation der Umgebung. 
...
\section{Theoretische Anwendung Neuronaler Netze}
