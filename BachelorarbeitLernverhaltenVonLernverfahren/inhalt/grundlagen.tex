...
\paragraph{Additive Gewinne} nach Russell und Norvig \cite[756]{Russell} oder das Modell des endlichen Horizonts %\cite[250]{Kaelblig, Littman and Moore} 

\subsection{Temporale Differenz Lernen}
\label{subsec:Temporale Differenz Lernen}
Das temporale Differenz Lernen auch TD-Lernen 
, lernen einer Heuristik
Gewichtungen der Heuristik werden aktualisiert?

\subsection{Verallgemeinerung beim verstärkenden Lernen}
\label{subsec:Verallgemeinerung}
